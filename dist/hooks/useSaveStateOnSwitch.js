...
export const useSaveStateOnSwitch = function () {
    const { rotate, zoom, image, setImage, setPreviousRotate, flipX, flipY, imagePosition, focalPoint, boxPosition, boxScale, dimensions, setDimensions, saveHistoryState, } = useImageEditorContext();
