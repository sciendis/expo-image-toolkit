 ...
 */
export const Alert = function ({ visible, onSubmit, onCancel, alertText, submitLabel, cancelLabel, }) {
    ...
    return (<View style={styles.overlay} pointerEvents={visible ? 'auto' : 'none'}>
      <Animated.View style={[
            styles.container,
            {
        ...
        <View style={styles.buttonsContainer}>
          <View style={styles.buttonsParent}>
            <TouchableOpacity style={[styles.button, { backgroundColor: colors.alertCancelBg }]} onPress={() => onCancel()}>
              <Text style={[styles.buttonText, { color: colors.alertCancelText }]}>
                {cancelLabel}
              </Text>
            </TouchableOpacity>
          </View>
          <View style={styles.buttonsParent}>
            <TouchableOpacity style={[styles.button, { backgroundColor: colors.alertSubmitBg }]} onPress={() => onSubmit()}>
              <Text style={[styles.buttonText, { color: colors.alertSubmitText }]}>
                {submitLabel}
              </Text>
            </TouchableOpacity>
          </View>
