 ...
 */
export const getCropData = function ({ dimensions: { scaleX, scaleY, centerX, centerY, imageWidth, imageHeight }, boxScale, boxPosition, imagePosition, zoom, focalPoint, activeEditor, }) {
    const focalPointVal = Object.assign({}, focalPoint.get());
    const boxScaleVal = Object.assign({}, boxScale.get());
    const zoomVal = zoom.get();
    const imagePosVal = Object.assign({}, imagePosition.get());
    const boxPosVal = Object.assign({}, boxPosition.get());
